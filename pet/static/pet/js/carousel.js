...
if (carouselChildren.length > 2){// Get the number of cards that can fit in the carousel at once
...
const infiniteScroll = () => {
    ...
    else if(Math.ceil(carousel.scrollLeft) === carousel.scrollWidth - carousel.offsetWidth - 5) {
